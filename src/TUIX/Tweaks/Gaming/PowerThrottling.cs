...
namespace TweakUIX.Tweaks.Gaming
{
    internal class PowerThrottling : TweaksBase
    {
        ...
        public override bool DoTweak()
        {
            ...
            { logger.Log("Could not disable PowerThrottling : {0}", ex.Message); }
        ...
        public override bool UndoTweak()
        {
            ...
            { logger.Log("Could not enable PowerThrottling : {0}", ex.Message); }
